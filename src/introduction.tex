...
events would be of use for organisations that employ OSS. For closed-source
software projects in a commercial environment, these events can be tracked by
the managerial history of the project. For OSS projects, this is not the case.
...
phases. Chapter \ref{background} provides background information and the
context of the research. Chapter \ref{research} describes the execution of the
research. In chapter \ref{results}, the results of research execution are
presented. Chapter \ref{analysis} discusses and analyses the results. Finally,
in Chapter \ref{conclusions} the conclusions are presented and the research
