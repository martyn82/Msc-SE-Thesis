...
In chapter \ref{method}, the phases and approach for the research is discussed
as well as the hypotheses. Chapter \ref{background} will provide information on
software evolution, wavelet analysis, and prior research in the field of OSS
project success and survivability Chapter \ref{research} describes the research
execution. In chapter \ref{results}, the results of the research are presented,
and chapter \ref{analysis} discusses the results and analysis and presents the
conclusions and answers of the research.
Chapter \ref{replication} compares this replicated research to the original
research.
