...
\begin{description}
	\item[Type A.] Type A patterns strictly detected at the end of the evolution
		...
		$x$ and ends at point $y$, the pattern starts at $x'$ and ends at $y$. In the
		data set, the maximum date $y$ of $P$ is June 2013.
	...
	\item[Type AB.] Type AB patterns are patterns that weakly satisfy the
		...
		distinguish strict from weak type A patterns.
\end{description}
